...
@Component({
  selector: 'app-tv-offer-top',
  templateUrl: './tv-offer-top.component.html',
  styleUrls: ['./tv-offer-top.component.scss'],
})
export class TvOfferTopComponent implements OnInit {
  /**
   * Card Title
   */
